...
void RigidModel::CreateSphere(uint32_t textureHandle)
{
	...
	//VertexResourceを生成
	vertexResource_ = modelPlatform_->GetDxCommon()->CreateBufferResource(sizeof(VertexData) * kVertexCount);
	...
	indexResource_ = modelPlatform_->GetDxCommon()->CreateBufferResource(sizeof(uint32_t) * kIndexCount);
...
void RigidModel::CreateCube(uint32_t textureHandle)
{
	modelData_ = std::make_unique<ModelData>();
	...
	//頂点数
	const uint32_t kVertexCount = kBoxSurfaceCount * 4;
	...
	//頂点Index数
	const uint32_t kIndexCount = kBoxSurfaceCount * 6;
	...
	//右面
	vertexData_[0] = { .position = {1.0f, 1.0f, -1.0f, 1.0f}, .texcoord = {0.0f, 0.0f}, .normal = {1.0f, 0.0f, 0.0f} };	//左上
	vertexData_[1] = { .position = {1.0f, 1.0f, 1.0f, 1.0f}, .texcoord = {1.0f, 0.0f}, .normal = {1.0f, 0.0f, 0.0f} };	//右上
	vertexData_[2] = { .position = {1.0f, -1.0f, -1.0f, 1.0f}, .texcoord = {0.0f, 1.0f}, .normal = {1.0f, 0.0f, 0.0f} };	//左下
	vertexData_[3] = { .position = {1.0f, -1.0f, 1.0f, 1.0f}, .texcoord = {1.0f, 1.0f}, .normal = {1.0f, 0.0f, 0.0f} };	//右下
	...
	//左面
	vertexData_[4] = { .position = {-1.0f, 1.0f, 1.0f, 1.0f}, .texcoord = {0.0f, 0.0f}, .normal = {-1.0f, 0.0f, 0.0f} };	//左上
	vertexData_[5] = { .position = {-1.0f, 1.0f, -1.0f, 1.0f}, .texcoord = {1.0f, 0.0f}, .normal = {-1.0f, 0.0f, 0.0f} };	//右上
	vertexData_[6] = { .position = {-1.0f, -1.0f, 1.0f, 1.0f}, .texcoord = {0.0f, 1.0f}, .normal = {-1.0f, 0.0f, 0.0f} };	//左下
	vertexData_[7] = { .position = {-1.0f, -1.0f, -1.0f, 1.0f}, .texcoord = {1.0f, 1.0f}, .normal = {-1.0f, 0.0f, 0.0f} };	//右下
	...
	//奥面
	vertexData_[8] = { .position = {1.0f, 1.0f, 1.0f, 1.0f}, .texcoord = {0.0f, 0.0f}, .normal = {0.0f, 0.0f, 1.0f} };	//左上
	vertexData_[9] = { .position = {-1.0f, 1.0f, 1.0f, 1.0f}, .texcoord = {1.0f, 0.0f}, .normal = {0.0f, 0.0f, 1.0f} };	//右上
	vertexData_[10] = { .position = {1.0f, -1.0f, 1.0f, 1.0f}, .texcoord = {0.0f, 1.0f}, .normal = {0.0f, 0.0f, 1.0f} };	//左下
	vertexData_[11] = { .position = {-1.0f, -1.0f, 1.0f, 1.0f}, .texcoord = {1.0f, 1.0f}, .normal = {0.0f, 0.0f, 1.0f} };	//右下
	...
	//手前面
	vertexData_[12] = { .position = {-1.0f, 1.0f, -1.0f, 1.0f}, .texcoord = {0.0f, 0.0f}, .normal = {0.0f, 0.0f, -1.0f} };	//左上
	vertexData_[13] = { .position = {1.0f, 1.0f, -1.0f, 1.0f}, .texcoord = {1.0f, 0.0f}, .normal = {0.0f, 0.0f, -1.0f} };	//右上
	vertexData_[14] = { .position = {-1.0f, -1.0f, -1.0f, 1.0f}, .texcoord = {0.0f, 1.0f}, .normal = {0.0f, 0.0f, -1.0f} };	//左下
	vertexData_[15] = { .position = {1.0f, -1.0f, -1.0f, 1.0f}, .texcoord = {1.0f, 1.0f}, .normal = {0.0f, 0.0f, -1.0f} };	//右下
	...
	//上面
	vertexData_[16] = { .position = {-1.0f, 1.0f, 1.0f, 1.0f}, .texcoord = {0.0f, 0.0f}, .normal = {0.0f, 1.0f, 0.0f} };	//左上
	vertexData_[17] = { .position = {1.0f, 1.0f, 1.0f, 1.0f}, .texcoord = {1.0f, 0.0f}, .normal = {0.0f, 1.0f, 0.0f} };	//右上
	vertexData_[18] = { .position = {-1.0f, 1.0f, -1.0f, 1.0f}, .texcoord = {0.0f, 1.0f}, .normal = {0.0f, 1.0f, 0.0f} };	//左下
	vertexData_[19] = { .position = {1.0f, 1.0f, -1.0f, 1.0f}, .texcoord = {1.0f, 1.0f}, .normal = {0.0f, 1.0f, 0.0f} };	//右下
	...
	//下面
	vertexData_[20] = { .position = {-1.0f, -1.0f, -1.0f, 1.0f}, .texcoord = {0.0f, 0.0f}, .normal = {0.0f, -1.0f, 0.0f} };	//左上
	vertexData_[21] = { .position = {1.0f, -1.0f, -1.0f, 1.0f}, .texcoord = {1.0f, 0.0f}, .normal = {0.0f, -1.0f, 0.0f} };	//右上
	vertexData_[22] = { .position = {-1.0f, -1.0f, 1.0f, 1.0f}, .texcoord = {0.0f, 1.0f}, .normal = {0.0f, -1.0f, 0.0f} };	//左下
	vertexData_[23] = { .position = {1.0f, -1.0f, 1.0f, 1.0f}, .texcoord = {1.0f, 1.0f}, .normal = {0.0f, -1.0f, 0.0f} };	//右下
...
void RigidModel::CreateRing(uint32_t textureHandle)
{
	...
	//頂点数
	const uint32_t kVertexCount = kRingDivide * 4;
	...
	//頂点Index数
	const uint32_t kIndexCount = kRingDivide * 6;
...
void RigidModel::CreateCylinder(uint32_t textureHandle)
{
	...
	//頂点数
	const uint32_t kVertexCount = kCylinderDivide * 4;
	...
	//頂点Index数
	const uint32_t kIndexCount = kCylinderDivide * 6;
