...
from .spawn import MYADDON_OT_spawn_create_wall_symbol
...
class TOPBAR_MT_my_menu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        self.layout.operator(MYADDON_OT_spawn_create_wall_symbol.bl_idname,
                             text=MYADDON_OT_spawn_create_wall_symbol.bl_label)
